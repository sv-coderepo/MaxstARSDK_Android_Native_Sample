...
public class ObjectFusionTrackerActivity extends AppCompatActivity {
	...
	protected void onResume() {
		...
		if(TrackerManager.getInstance().isFusionSupported()) {
			...
			TrackerManager.getInstance().addTrackerData("ObjectTarget/obj_1015_32.3dmap", true);
			TrackerManager.getInstance().addTrackerData("{\"object_fusion\":\"set_length\",\"object_name\":\"obj_1015_32\", \"length\":0.07}", false);
